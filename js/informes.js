        ...
        for (let i = 0; i < arrayDatos.length; i++) {
            ...
            fetch(`https://elecciones-lc2.bruselario.com/api/resultados/getResultados/?anioEleccion=${añoElegido}&tipoRecuento=${tipoRecuento}&tipoEleccion=${tipoEleccion}&categoriaId=${categoriaId}&distritoId=${distritoElegidoId}&seccionProvincialId=${seccionProvinciaElegida}&seccionId=${idSeccionElegidaId}&circuitoId=${circuitoId}&mesaId=${mesaId}`)
                ...
                .then(data => {
                    ...
                    estadoRecuento = data.estadoRecuento //esto es para mesas, electores y participacion sobre escrutado

                    let mapa = mapas[distritoElegido]; //mapa
                    ...
                    recuadroInformes.innerHTML = `
                        <tr>
                            ...
                            <th class="th-grilla-texto">
                                <div class="grilla-texto">
                                    <p class="texto-elecciones-chico" id="titulo">Elecciones ${añoElegido} | ${tipoEleccion}</p>
                                    <p class="texto-path-chico" id="subtitulo">${añoElegido} > ${tipoEleccion} > ${cargoElegido} > ${distritoElegido} > ${seccionElegida} </p>
                                </div>
                            </th>
                            <th class="th-datos-generales">
